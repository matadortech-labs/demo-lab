...
$BackupRoot = "C:\KeyfactorScripts\EndpointValidation\Backups\EndpointValidationCustomJob-v7-$Timestamp"
...
Write-Host "Installed EndpointValidation custom job extension v7." -ForegroundColor Green
